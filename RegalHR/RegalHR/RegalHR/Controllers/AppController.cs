...
namespace RegalHR.Controllers
{
    public class AppController : Controller
    {
        ...
        /// <returns></returns>
        public JsonResult RegDeviceToken(string EmployeeNo, string deviceToken)
        {
               APNFactory ModelFactory = new APNFactory();
               bool ret = ModelFactory.InsertUpdateDeviceToken(EmployeeNo, deviceToken);
